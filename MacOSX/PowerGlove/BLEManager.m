...
// UUID match Adafruit nRF8001
#define SERVICE_UUID     @"6e400001-b5a3-f393-e0a9-e50e24dcca9e"
#define READ_CHAR_UUID   @"6e400002-b5a3-f393-e0a9-e50e24dcca9e"
...
-(void) centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary *)advertisementData RSSI:(NSNumber *)RSSI{
    ...
    NSLog(@"GOING TO COMPARE:\n%@\n%@",str, SERVICE_UUID);
    
    if([[str uppercaseString] isEqualToString:[SERVICE_UUID uppercaseString]]){
...
- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error {
    NSLog(@"delegate: didWriteValueForCharacteristic %@", characteristic.UUID);
}
